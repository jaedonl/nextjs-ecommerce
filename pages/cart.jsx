                                ...
                                <td>
                                    <span className={styles.extras}>
                                        {product.extras.map((extra, idx) => (
                                            <span key={extra._id}>
                                                {extra.text}
                                                {(product.extras.length > 1 && idx !== product.extras.length-1) && <span>, </span>} 
                                            </span>
                                        ))}
                                    </span>
                                </td>
                    ...
                    {open ? (
                        <div className={styles.paymentMethods}>
                            ...
                            <PayPalScriptProvider
                                options={{ 
                                    "client-id": "AWCXn754KyUUWJpvNNgk91bmrAZBihValxRTCPntgHSCzE6IQGyN2O0OZKTNwiqjqXZIZu2gPyHl1_lS",
                                    components: "buttons",
                                    currency: "USD",
